...
const Finance = () => {
  ...
  const [financeData, setFinanceData] = useState<ContentItem[]>([]);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState<string | null>(null);

  useEffect(() => {
    dispatch(setActiveSection('finance' as any));
    fetchFinanceData();
  }, [dispatch]);
      ...
      <div className="flex">
        ...
        >
          <div className="container max-w-7xl mx-auto">
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Business news and financial market insights
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {loading && (
              ...
              >
                <div className="flex items-center gap-3 text-muted-foreground">
                  ...
                  <span>Loading financial news...</span>
                </div>
              </motion.div>
            )}
            ...
            {!loading && !error && financeData.length > 0 && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            {!loading && !error && financeData.length === 0 && (
              ...
              >
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2">No Finance Content Available</h3>
                  <p className="text-muted-foreground mb-4">
                    We couldn't find any financial content at the moment.
                  </p>
                  <Button onClick={handleRefresh} variant="outline">
                    Refresh
                  </Button>
